...
export default class HomeKitDevice {
    ...
    constructor(accessory, api, log, eventEmitter, deviceData) {
        ...
        if (typeof api?.version === 'number' &&
            typeof api?.hap === 'object' &&
            typeof api?.HAPLibraryVersion === 'undefined') {
        ...
        if (typeof api?.HAPLibraryVersion === 'function' &&
            typeof api?.version === 'undefined' &&
            typeof api?.hap === 'undefined') {
    ...
    async add(accessoryName, accessoryCategory, useHistoryService) {
        if (this.hap === undefined ||
            ...
            typeof this.deviceData?.uuid !== 'string' || this.deviceData.uuid === '' ||
            typeof this.deviceData?.serial_number !== 'string' || this.deviceData.serial_number === '' ||
        ...
        if (typeof HomeKitDevice?.HISTORY === 'function' &&
        ...
        if (this.#platform === undefined) {
            ...
            this.accessory.publish({
                ...
                //advertiser: this.mDNSAdvertiser,
            });
        }
    }
    ...
    async update(deviceData, forceUpdate) {
        ...
        if ((changedData === true || forceUpdate === true) &&
            this.accessory !== undefined) {
            ...
            if (typeof deviceData?.online === 'boolean' &&
                deviceData.online !== this.deviceData.online) {
        ...
        switch (type) {
            case HomeKitDevice.ADD : {
                ...
                if (typeof message?.name === 'string' &&
                    ...
                    typeof message?.history === 'boolean') {
